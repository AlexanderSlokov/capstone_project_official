...
from configurations import CHROMA_SETTINGS, EMBEDDING_MODEL_NAME, PERSIST_DIRECTORY, MODEL_ID, MODEL_BASENAME
...
def model_memory():
    ...
    just say that you don't know, don't try to make up an answer. After that,you must translate the answer to\
